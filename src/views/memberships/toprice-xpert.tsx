...
const TopriceXpert = () => {
  ...
  const membership_toprice_xpert_rest_days = getRestDaysMembership(
    user.subscription?.toprice_xpert?.expires_at
  )
      ...
      <div className="grid grid-cols-[min-content_1fr] w-max gap-x-4">
        ...
        {is_active_toprice_xpert && (
          <>
            ...
            <span className="font-bold">
              {dayjs(
                user.subscription.toprice_xpert!.expires_at!.seconds * 1000
