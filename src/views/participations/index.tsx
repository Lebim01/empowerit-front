  ...
  return (
    <div className="flex flex-col space-y-2 2xl:w-[1200px] 2xl:mx-auto">
      ...
      <div className='flex justify-between'>
        <div
          className="card transition duration-150 ease-in-out card-border user-select-none w-[280px] mr-2 lg:w-[350px]"
        >
        ...
        <div
          className="card transition duration-150 ease-in-out card-border user-select-none w-[280px] lg:w-[350px]"
        >
          ...
          <div className="flex flex-col space-y-4 justify-center text-center">
            {participations.map((participation, index) => (
              <div key={index} className="w-full flex  justify-center items-center">
                <CapSliderParticipations participation={participation} index={index} />
              </div>
            ))}
          </div>
        )
      ...
      <div className="flex items-center space-x-4">
        <span className="font-bold text-lg my-4">Historial de Participaciones</span>
      </div>
      {participations && participations.length > 0 && (
